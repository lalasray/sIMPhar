...
imp_encoder_type = config.imp_encoder_type

if imp_encoder_type == "cnn":

    class ImpEncoder(nn.Module):
        def __init__(self, input_dim=(2, 50), embedding_dim=512):
...
elif imp_encoder_type == "spatiotemporal":
...
#batch_size = 16
#input_tensor = torch.randn(batch_size, 2, 50)
#model = ImpEncoder(embedding_dim = 512)
